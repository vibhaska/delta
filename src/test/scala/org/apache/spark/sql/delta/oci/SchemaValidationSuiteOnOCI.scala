...
trait SchemaValidationSuiteBaseOnOCI extends QueryTestOnOCI with SharedSparkSession
 ...
 */
class SchemaValidationSuiteOnOCI extends SchemaValidationSuiteBaseOnOCI {
