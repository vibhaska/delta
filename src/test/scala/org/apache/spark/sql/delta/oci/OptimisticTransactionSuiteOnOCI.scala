...
import org.apache.spark.sql.delta.{ConcurrentAppendException, ConcurrentDeleteDeleteException, ConcurrentDeleteReadException, ConcurrentTransactionException, DeltaConcurrentModificationException, DeltaErrors, DeltaLog, MetadataChangedException}
import org.apache.spark.sql.oci.QueryTestOnOCI
import org.apache.spark.sql.Row
import org.apache.spark.sql.test.SharedSparkSession
import org.apache.spark.sql.types.{StringType, StructField, StructType}

class OptimisticTransactionSuiteOnOCI extends QueryTestOnOCI with SharedSparkSession {
