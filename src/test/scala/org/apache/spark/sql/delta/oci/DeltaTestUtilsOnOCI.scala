...
import org.apache.spark.sql.delta.{DeltaTestUtilsBase, OptimisticTransaction}
import org.apache.spark.sql.delta.actions.{Action, AddFile, Metadata, Protocol, SingleAction}

trait DeltaTestUtilsBaseOnOCI {
...
object DeltaTestUtilsOnOCI extends DeltaTestUtilsBase
