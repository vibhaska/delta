...
import org.apache.spark.sql.delta.{ConcurrentWriteException, DeltaErrors}
import org.apache.spark.sql.oci.QueryTestOnOCI
import org.apache.spark.sql.test.{SQLTestUtils, SharedSparkSession}

trait DeltaErrorsSuiteBaseOnOCI
...
class DeltaErrorsSuiteOnOCI
  extends DeltaErrorsSuiteBaseOnOCI
