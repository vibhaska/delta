...
trait DeltaDDLUsingPathTestsOnOCI extends QueryTestOnOCI
...
class DeltaDDLUsingPathSuiteOnOCI extends DeltaDDLUsingPathTestsOnOCI with DeltaSQLCommandTest {
}
