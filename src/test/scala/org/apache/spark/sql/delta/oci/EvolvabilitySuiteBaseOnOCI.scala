...
import org.apache.spark.sql.delta.{CheckpointMetaData, DeltaLog}
import org.apache.spark.sql.{QueryTest, SparkSession}
import org.apache.spark.sql.execution.streaming.MemoryStream
import org.apache.spark.sql.oci.{QueryTestOnOCI, TestUtilsOnOCI}
import org.apache.spark.sql.test.SharedSparkSession
import org.apache.spark.sql.types.StructType
import org.apache.spark.util.Utils

trait EvolvabilitySuiteBaseOnOCI extends QueryTestOnOCI with SharedSparkSession {
 ...
 */
// scalastyle:on
object EvolvabilitySuiteBaseOnOCI extends TestUtilsOnOCI {
  ...
  def generateData(spark: SparkSession, path: String): Unit = {
    ...
    val checkpoint = createTempDirOnOCI()(spark).toString
